                        ...
                        <li class="nav-item dropdown" v-for="(item, index) of menuItems" :key="index">
                            ...
                            <div class="dropdown-menu row" aria-labelledby="topnav-dashboard" v-if="hasItems(item)">
                                <template v-for="(subitem, index) of item.subItems">
                                    <router-link :key="index" class="col dropdown-item side-nav-link-ref" v-if="!hasItems(subitem)" :to="subitem.link">{{ subitem.label }}</router-link>
                                    <div class="dropdown" v-if="hasItems(subitem)" :key="index">
                                        ...
                                        <div class="dropdown-menu">
                                            <router-link v-for="(subSubitem, index) of subitem.subItems" :key="index" :to="subSubitem.link" class="dropdown-item side-nav-link-ref">{{ subSubitem.label }}</router-link>
                                        </div>
                                    </div>
                                </template>
                            </div>
