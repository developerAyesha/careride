...
exports.up = async function(knex) {
  await knex.schema.createTable('user_inf', function(t) {
    ...
    t.specificType('activated', 'tinyint(1)').unsigned().notNullable().default(0);
    ...
    t.string('facility_name', 32).notNullable().default('');
